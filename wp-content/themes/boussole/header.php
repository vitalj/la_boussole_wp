...
<div class="photo-up" id="photo-up">
        <a id="closeBtn" class="closeBtn">X</a> 

        <div class="leftarrowslot" id="Larrow"><span class="arrow"><</span></div>
        <div class="rightarrowslot" id="Rarrow"><span class="arrow">></span></div>
			
 </div>
<div  class="popup"><img id="full-screen-photo" src="" class="full-screen-photo"></div>
